...
const MessagesStatsTable = () => {
  ...
  const lines: Line[] = [
    ...
    },
    {
      ...
      tooltip: (
        <>
          <b>{stats ? ((stats.edited / stats.total) * 100).toFixed(2) : '-'}%</b> of total messages were edited
        </>
      ),
    },
    {
    ...
    },
    {
      ...
      value:
        duration && duration.longestTimeWithoutMessages ? duration.longestTimeWithoutMessages.minutes * 60 : undefined,
      tooltip: (
        <>
    ...
    },
    {
      ...
      value:
        duration && duration.longestActiveConversation ? duration.longestActiveConversation.minutes * 60 : undefined,
      tooltip: (
        <>
          ...
          <br />
          <br />
          <b>❓ Active conversation:</b> considered still active if the time between the previous and next message is
          less than 10 minutes. Makes more sense when filtering by a single channel.
        </>
      ),
    },
    {
