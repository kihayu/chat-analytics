...
const ReportDashboard = () => {
  ...
  const sections: Section[] = useMemo(() => {
    ...
    const stopwordsTooltip = (
      <>
        ⚠️ Note that stopwords (words that don't add meaningful information such as "the", "a", etc) are <b>not</b>{' '}
        taken into account
      </>
    )
    ...
    return [
          ...
          <Card
            ...
            tooltip={
              database.config.platform === 'whatsapp' ? (
                <>
                  ⚠️ Note that if the chat has been exported from Android it may not contain information about the media
                  type (image, sticker, etc). iOS exports do.
                </>
              ) : undefined
            }
          />,
          ...
          platformInfo.support.edits
            ? [
                <Card
                  ...
                  tooltip={
                    <>
                      If a message has been edited multiple times, it will count as if it was edited only once.
                      <br />
                      For the percentage, the author/channel <b>must have at least 100 messages</b> with the current
                      filters
                    </>
                  }
                />,
      ...
      },
      {
        ...
        cards: [
          ...
          />,
          <Card num={1} title="Language statistics" children={LanguageStatsTable} tooltip={stopwordsTooltip} />,
        ],
      },
      {
        name: '😃 Emoji',
      ...
      },
      {
        ...
        cards: [<Card num={1} title="Most mentioned" children={MostMentioned} />]
          .concat(
            platformInfo.support.reactions
              ? [
                  <Card num={1} title={['Top reacted messages', ['(total)', '(single)']]} children={TopReacted} />,
                  <Card
                    num={1}
                  ...
                  <Card
                    ...
                    tooltip={
                      <>
                        ...
                        <br />
                        <br />
                        <b>❓ Between the top:</b> only the 20 most active authors in the period selected are shown here
                      </>
                    }
                  />,
                ]
