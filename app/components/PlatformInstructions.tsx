  ...
  return (
    <>
      <ol>
        ...
        <li>
          In the "Request a download" tab, change the format to <b>JSON</b>, media quality to <b>Low</b> (since media
          files are not analyzed) and Date range to <b>All time</b> (if you want).
          <img src={FacebookTab} />
        ...
        <li>
          Now wait until the data is ready (may take a day or two), you can find it in the "Available files" tab.
          Extract the ZIP you downloaded and navigate to the folder <code>messages/inbox/</code> and find the chat you
          want to analyze.
        </li>
      </ol>
    </>
  ...
  return (
    <>
      ...
      <ol>
        ...
        <li>
          When asked to export with or without media, <b>select Without Media</b>. Media files are not analyzed.
